"""Painted delegates for interactive cells (checkbox, button).

Both use ``editorEvent`` for clicks and ``paint`` for visuals — zero per-row
widget cost, scales to tens of thousands of rows.
"""
